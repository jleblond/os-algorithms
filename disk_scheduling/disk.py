...
class Disk:
    ...
    def compute(self):
        algorithms.fcfs(self.requests_queue, self.head_cylinder)

        algorithms.scan(self.requests_queue,
                        self.head_cylinder,
                        self.lower_cylinder, self.upper_cylinder,
                        self.is_moving_towards_0)

        algorithms.c_look(self.requests_queue, self.head_cylinder, self.is_moving_towards_0)
